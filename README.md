# Japan Video Editor — Claude Skill

A Claude skill that automates the production of bilingual (JP/EN) vertical short videos for TikTok / Instagram Reels / YouTube Shorts from raw iPhone footage.
...
git clone git@github.com:Thesalmar/japan-video-editor-skill.git \
  ~/.claude/skills/video-editing/japan-video-editor
```

Claude Code picks up the skill automatically on next launch — no config change needed.
