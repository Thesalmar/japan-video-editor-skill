...
```json
{
  ...
  "start": 7.2,
  "end": 11.4,
  "text_jp": "今日から使えるポイントがあります",
  "text_en": "There are tips you can use right away.",
  "style": "primary",
  "emphasis": ["外国人だから"]
}
```
...
- **Keep `text_en` under 8 words per segment.** It's a comprehension aid, not a translation. Compress aggressively. "今日から使えるポイントがあります" → "Tips you can use right away."
