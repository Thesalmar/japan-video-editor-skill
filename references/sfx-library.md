...
| `金額表示.mp3` | Cash register | Money amounts or numerical values |
...
Assign SFX to `highlight: true` captions only. Typical mapping pattern for a 3-point Japanese short-form video:
